...
public:
    ...
    //patriksc: mod
    /*
    void register_opt_data_publisher(){
        pub_opt_data_ = nh_.advertise<jslam_msgs::orbslam_optimization_data>("orb_opt_data",1);
        std::cout << "patrisc: optimization data publisher initialized" << std::endl;
    }
private:
    ros::NodeHandle nh_;
    ros::Publisher pub_opt_data_;
    */
    //------------------------------
};
